...
public class GLMModel extends Model<GLMModel,GLMModel.GLMParameters,GLMModel.GLMOutput> {
  ...
  public void initScoringInfo(GLMParameters parms, int nclasses) {
    scoringInfo = ScoringInfo.prependScoringInfo(null, scoringInfo);
    scoringInfo = new ScoringInfo[1];
    scoringInfo[0].is_classification = nclasses > 1;
    scoringInfo[0].validation = parms.valid() != null;
    scoringInfo[0].time_stamp_ms = _output._start_time;
  }
  ...
  public void addScoringInfo(GLMParameters parms, int nclasses, long currTime) {
    ...
    currInfo.total_training_time_ms = _output._training_time_ms.get(_output._training_time_ms.size()-1);
...
//        beta[beta.length-1] = this.beta[this.beta.length-1];
  ...
  public static class GLMOutput extends Model.Output {
    ...
    public List<Long> _training_time_ms = new ArrayList<>();
